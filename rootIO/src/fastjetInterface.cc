...
fastjetInterface::fastjetInterface() {
  ...
  fjets_constituents = nullptr;
  fjets_constituents_fibernum = nullptr;
}

fastjetInterface::~fastjetInterface() {
  if (fJets) delete fJets;
  if (fJetBase) delete fJetBase;
  if (fjets_constituents != nullptr) delete[] fjets_constituents;
  if (fjets_constituents_fibernum != nullptr) delete[] fjets_constituents_fibernum;
}
